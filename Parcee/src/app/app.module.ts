...
@NgModule({
  ...
  providers: [StatusBar, AddPartyProvider, GetPartiesProvider , SplashScreen, Camera, GooglePlus, { provide: ErrorHandler, useClass: IonicErrorHandler }, LoginProvider, LogoutProvider, LoadingProvider, AlertProvider, ImageProvider]
})
