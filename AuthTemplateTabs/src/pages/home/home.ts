...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public alertCtrl: AlertController, public navParams: NavParams, public app: App,
    ...
    public angularfireDatabase: AngularFireDatabase, public alertProvider: AlertProvider, public camera: Camera) {
  ...
  ionViewDidLoad() {
    ...
    this.angularfireDatabase.object('/accounts/' + firebase.auth().currentUser.uid).subscribe(account => {
      this.user = account;
